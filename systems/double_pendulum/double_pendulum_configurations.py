...
from systems.double_pendulum.data import make_data
from systems.double_pendulum.double_pendulum_visualizations import make_live_plot, make_animation
from systems.double_pendulum import pinn as dp_pinn
from systems.double_pendulum.hnn import HAMILTONIAN, make_hamiltonian_parametric
from systems.double_pendulum.lnn import LAGRANGIAN, make_lagrangian_parametric
...
SYSTEM = SystemConfig(
    ...
    period=2.0,
    seed=0,
    system_params={"m1": 1.0, "m2": 1.0, "l1": 1.0, "l2": 1.0, "g": 9.81},
)
...
PINN_LOSS = PINNLossConfig(
    ...
    residual_fn    = dp_pinn.DoublePendulumPINNLoss,
    causal_epsilon     = 0.0,
