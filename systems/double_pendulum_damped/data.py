...
class double_pendulum_damped_data_generator:
    ...
    def damping_torque(self, qdot, xp=np):
        return self.gamma * qdot[..., 0], self.gamma * qdot[..., 1]
...
def make_data(config):
    return double_pendulum_damped_data_generator(config, config.system.seed)
