...
def search_space_hnn_port_hamiltonian(trial, base_config):
    return search_space_hnn_parametric(trial, base_config)
...
def search_space_lnn_learned_dissipation(trial, base_config):
    return search_space_lnn_parametric(trial, base_config)
...
SEARCH_SPACES = {
    ...
    "hnn_port_hamiltonian":    search_space_hnn_port_hamiltonian,
    "lnn":                     search_space_lnn,
    "lnn_parametric":          search_space_lnn_parametric,
    "lnn_learned_dissipation": search_space_lnn_learned_dissipation,
